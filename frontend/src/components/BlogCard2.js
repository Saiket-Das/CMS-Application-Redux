  ...
  return (
    <div>
      <Link
        ...
        href="#"
        className="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 shadow-xl hover:bg-slate-100"
      >
        <img
          alt=""
        ...
        <div className="p-6 space-y-2 lg:col-span-5">
          <h3 className="mb-4 text-2xl  font-semibold sm:text-4xl ">
